    ...
    <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <div className="text-center lg:text-left">
        <h1 className="text-4xl tracking-tight font-extrabold text-white lg:text-gray-900 sm:text-5xl md:text-6xl">
          ...
          <span className={`block text-primary xl:inline font-display`}>MAKEUP</span>
        </h1>
        <p className="mt-3 text-base text-white lg:text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
          Tự tin tỏa sáng với <strong>Đoan Trang Makeup</strong> – nơi vẻ đẹp của bạn được chăm chút
          từ từng nét cọ. Chúng tôi mang đến phong cách trang điểm hiện đại, nhẹ nhàng, giúp bạn nổi
          bật nhưng vẫn giữ được nét riêng.
        </p>
