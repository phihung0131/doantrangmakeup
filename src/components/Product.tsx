      ...
      <div className={`container max-w-5xl mx-auto m-8`}>
        ...
        <div className="flex flex-wrap items-center">
          ...
          <div className="w-full sm:w-1/2 p-4 sm:p-6 mt-6 sm:mt-20 order-2 sm:order-1">
            ...
            <p className="text-gray-600 text-sm sm:text-base leading-relaxed">
              Mỗi cô dâu đều xứng đáng tỏa sáng trong ngày trọng đại nhất của cuộc đời. Với Đoan
              Trang Makeup, chúng tôi không chỉ tạo nên lớp trang điểm hoàn hảo, mà còn giúp bạn giữ
              được vẻ đẹp tự nhiên, trong trẻo và rạng rỡ suốt cả ngày dài. Phong cách trang điểm
              tinh tế, hài hòa với đường nét khuôn mặt sẽ giúp bạn thật tự tin trong từng khoảnh
              khắc.
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-wrap items-center">
          ...
          <div className="w-full sm:w-1/2 p-4 sm:p-6 mt-6 sm:mt-20 order-2 sm:order-2">
            ...
            <p className="text-gray-600 text-sm sm:text-base leading-relaxed">
              ...
              <strong> Đoan Trang Makeup </strong> sẽ giúp bạn thật nổi bật với phong cách trang
              điểm phù hợp. Chúng tôi mang đến vẻ đẹp rạng rỡ nhưng vẫn tinh tế, giúp bạn tự tin
              xuất hiện trước mọi ánh nhìn. Lớp nền mỏng nhẹ, bền màu và đôi mắt được nhấn nhá vừa
              đủ sẽ giúp bạn tỏa sáng suốt buổi tiệc.
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-wrap items-center">
          ...
          <div className="w-full sm:w-1/2 p-4 sm:p-6 mt-6 sm:mt-20 order-2 sm:order-1">
            ...
            <p className="text-gray-600 text-sm sm:text-base leading-relaxed">
              Chụp ảnh ngoại cảnh đòi hỏi lớp trang điểm vừa tự nhiên vừa bền màu dưới ánh sáng và
              thời tiết. <strong>Đoan Trang Makeup</strong> mang đến phong cách trang điểm trong
              suốt, tươi tắn và phù hợp với bối cảnh, giúp gương mặt bạn luôn rạng rỡ dù ở bất kỳ
              góc chụp nào. Lớp nền được xử lý nhẹ nhàng, mỏng mịn nhưng vẫn đảm bảo che phủ tốt,
              giúp bạn tự tin trong mọi khung hình ngoài trời.
            </p>
          </div>
        </div>
      </div>
